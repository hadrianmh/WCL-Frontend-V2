...
if($action != ''){
    ...
    $query = "SELECT $tabel1.id, $tabel1.id_fk, $tabel1.tgl, $tabel1.keterangan, $tabel1.masuk, $tabel1.keluar, $tabel1.sisa, $tabel2.id_fk, $tabel2.saldo FROM $tabel1 LEFT JOIN $tabel2 ON $tabel1.id_fk = $tabel2.id_fk WHERE $tabel1.id_fk='$curMonth' ORDER BY $tabel1.id ASC";
    $sql = $connect->query($query);
