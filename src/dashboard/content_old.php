  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class ="container-fluid">
          <?php if($_SESSION['role'] != '5'){ ?>
            <button type="button" class="button" id="add_inputPO">Input PO</button>
          <?php } ?>
            ...
            <div class="modal-content">
              ...
              <form class="form add" id="form_print" data-id="" novalidate>
                ...
                <div class="form-group pilihBANK">
                  ...
                  <select class="form-control" id="pilihBANK" name="pilihBANK" required>
                    <?php
                    ...
                    <option value="" disabled selected>Pilih Bank :</option>
                      <?php while($row = $sql->fetch_array()){
                        $ex = explode('-', $row['isi']); ?>
                        <option value="<?php echo $row['isi']; ?>"><?php echo $ex[0]; ?> - <?php echo $ex[1]; ?> - <?php echo $ex[2]; ?></option>   
                      <?php }
                    } ?>
                    </select>
                </div>
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="row">
        <div class ="container-fluid">
          <?php if($_SESSION['role'] != '5'){ ?>
            <button type="button" class="button" id="add_inputPO">Input PURCHASE ORDER</button>
          <?php } ?>
